  ...
  return (
    <footer className="footer-section">
      <div className="container">
        <div className="footer-grid">
          ...
          <div className="footer-col brand-col">
            ...
            <p className="footer-desc">
              Smarter digital marketing. Better results. A premier digital agency building websites, apps, and growth systems.
            </p>
          </div>
        ...
        {/* Sub-Footer Social & Copyright Bar */}
        <div className="footer-sub-bar">
          <div className="sub-bar-left">
            <span>&copy; {new Date().getFullYear()} FOUROVR. All rights reserved.</span>
          </div>

          <div className="sub-bar-center">
            <span className="sub-brand-name">FOUROVR</span>
          </div>
      ...
      {/* Huge Giant Scrolling Text Banner at Very Bottom */}
      <div className="giant-footer-marquee">
        <div className="giant-marquee-track">
          <span>LET'S WORK TOGETHER ✦ FOUROVR ✦ LET'S WORK TOGETHER ✦ FOUROVR ✦ </span>
          <span>LET'S WORK TOGETHER ✦ FOUROVR ✦ LET'S WORK TOGETHER ✦ FOUROVR ✦ </span>
        </div>
      </div>
    </footer>
